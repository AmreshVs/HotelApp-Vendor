    ...
    <View style={styles.bodyContainer}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.contentContainer}>
          ...
          {data.length <= 0 ? <BookedDetailsSK /> : <BookedHotelDetails data={data} token={props.access_token} reloadData={reloadData} user_type={props.navigation.state.params.user_type} notify_id={props.navigation.state.params.notify_id} />}
